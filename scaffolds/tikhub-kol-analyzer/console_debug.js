// Debug script - verify fixed MD5 with known-good values
(function() {
...
// Test with known values from the curl
var uid = '7000802688678872069';
var _time = '1784373945';
var cnonce = '97357189';

var raw = '_time' + _time + SALT + 'cnonce' + cnonce + SALT + 'uid' + uid + SALT;
var digest = md5(raw);
...
console.log('MD5:', digest, '(should be 29d46ffaa8553d3f23d6d9a06268ec98)');
console.log('Sign:', sign, '(should be a01ae9dca2c8500d23d6d9a06268ec98)');
console.log('Match:', sign === 'a01ae9dca2c8500d23d6d9a06268ec98');
})();
