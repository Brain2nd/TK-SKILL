...
from tikhub_pipeline.search_keywords import SEARCH_KEYWORDS
...
from tikhub_pipeline.pipeline import hard_filter, must_pass_filter, calculate_scores
from tikhub_pipeline.demographics import compute_western_ratio_from_ids
from tikhub_pipeline.claude_client import score_all_creators_dogegoo
from tikhub_pipeline.output import export_scored_csv
...
def main():
    ...
    # ── Phase 1: Search ───────────────────────────────────────────────────────
    if args.mock:
        from tikhub_pipeline.mock_data import MOCK_CREATORS, MOCK_DEEP_ANALYSIS
