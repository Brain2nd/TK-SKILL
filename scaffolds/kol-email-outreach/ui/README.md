...
面向红人营销团队的中文项目管理界面。系统消费 TikHub 人物画像结果，按项目管理达人、英文邮件母模板、发件邮箱、AI 个性化、人工审批和安全发送。
...
1. 在“审批与发送”点击“AI 生成 N 封审批邮件”。
2. 系统先校验发件邮箱和收件人，再逐达人生成 Hook。
3. AI 生成期间如果项目设置发生变化，快照哈希校验会拒绝创建旧批次。
4. 逐封检查英文邮件与全部人工警告。
